...
VERSION = get_version('task1', '__init__.py')
...
setup(
    name='task1',
    version=VERSION,
    description="""Filtering courses""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Danyal Faheem',
    author_email='danyal.faheem@arbisoft.com',
    url='https://github.com/openedx/task1',
    ...
    entry_points={
        "lms.djangoapp": [
            "my_app = /Users/danyal.faheem/.virtualenvs/edx-cookiecutters/bin/python3.my_app.apps:Task1Config",
        ],
        "cms.djangoapp": [
        ],
    },
