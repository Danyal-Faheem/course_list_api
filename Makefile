...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd task1 && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd task1 && i18n_tool generate

detect_changed_source_translations:
	cd task1 && i18n_tool changed
...
pull_translations:
	find task1/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/task1/task1/conf/locale:task1/conf/locale
